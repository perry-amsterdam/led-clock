...
class RebootResponse {
  ...
  factory RebootResponse.fromJson(Map<String, dynamic> json) => RebootResponse(
        rebooting: json['rebooting'] as bool?,
...
class SetTimezoneResult {
  ...
  factory SetTimezoneResult.fromJson(Map<String, dynamic> json) => SetTimezoneResult(
