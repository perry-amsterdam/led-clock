        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              SizedBox(
                width: 260,
                child: IkeaCtaButton(onPressed: () {}, child: const Text('GROTE KNOP'), leading: Icons.play_circle),
              ),
              SizedBox(
                width: 220,
              ...
              SizedBox(
                width: 220,
                child: ElevatedButton(onPressed: () {}, child: const Text('ElevatedButton')),
              ),
              SizedBox(
                width: 220,
            ...
            child: Column(
              children: const [
                ListTile(
                  ...
                  title: Text('Tijdzone'),
                  subtitle: Text('Europe/Amsterdam'),
                  trailing: Icon(Icons.chevron_right),
                ),
                Divider(height: 1),
                ListTile(
                  leading: Icon(Icons.brightness_6),
                  title: Text('Helderheid'),
                  subtitle: Text('75%'),
