...
void handleRoot()
{
	...
	server.send(200,"text/html", htmlWrap(
		...
		"<input id='ssid' name='ssid' required placeholder='Bijv. MijnNetwerk' autocapitalize='none'/>"
		"</div>"

		"<div class='field'>"
		"<label for='pass'>Wachtwoord</label>"
		"<input id='pass' name='pass' type='password' required placeholder='\342\200\242\342\200\242\342\200\242\342\200\242\342\200\242\342\200\242\342\200\242\342\200\242'/>"
		"<div class='row note'>"
