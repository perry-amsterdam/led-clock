...
// Kies één lib: Adafruit_NeoPixel (aanbevolen op ESP32-S3)
...
#endif
#ifndef LED_COUNT
  #define LED_COUNT  60     // Pas aan: aantal leds
#endif
...
void ws2812bUpdate(const tm& now, time_t /*epoch*/) {
  ...
  uint16_t posHour = map(hour * 5 + (min/12), 0, 59, 0, LED_COUNT-1); // uur met min-meeschuif
